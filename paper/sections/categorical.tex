...
of set membership in heirarichal ordered categorical sets, so the \{d_0, \dots, d_n} \in D
  ...
  categorical via binning. Many-to-many PCP is a more general form of Parallel
  Sets wherein there are no cross tabulation tables but all pairs are
  explored. 
  %%add citation for many-to-many-pcp 
