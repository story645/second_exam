...
%% this can as easily be 311 data, but I don't have a citation for that
 ...
 plots \cite{tukey_exploratory_1977, friendly_visualizing_2000}.

 While conditional  distributions can somewhat be visualized using Fourfold displays,
 Mosiac displays, and using logit models, these plots have somewhat limited
 dimensionality and are somewhat limited to 3 sets of categories
 \cite{friendly_visualizing_2000}. Another approach is to [insert correlation
   paper here...]
...
\begin{figure}
  ...
  \label{fig:upsetfig1}
\end{figure}
While UpSet is designed with all sorts of sets in mind, the Parallel Sets tool
showin in figure~\ref{fig:upsetfig} is expicilitly designed to show frequencies of set membership in heirarichal
ordered categorical sets, so the \{d_0, \dots, d_n} \in D
